...
int main()
{
	...
	cout << "withdraw " << withdrawalAmount << " from account1 " << "( " << account1.getName() << " )" << endl;
	cout << "\nYour Balance is: " << account1.getBalance() << endl;
	...
	cout << "withdraw " << withdrawalAmount << " from account2 " << "( " << account2.getName() << " )" << endl;
	cout << "\nYour Balance is: " << account2.getBalance() << endl;
